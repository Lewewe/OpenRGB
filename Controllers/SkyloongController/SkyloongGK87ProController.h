...
class SkyloongGK87ProController
{
public:
    SkyloongGK87ProController(hid_device* dev_handle, const char* path, std::string dev_name);
    ~SkyloongGK87ProController();
